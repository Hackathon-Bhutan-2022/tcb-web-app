...
export default function AddEvents({handleAction, open}) {
  ...
  return (
    <div>
      ...
      >
        <DialogTitle>{'New Events'}</DialogTitle>
        <Formik>
          {({values, isSubmitting, setFieldValue, ...formik}) => (
            <Form>
              <DialogContent style={{width: 400}}>
                <Field component={TextField} name="title" variant={'outlined'} label={'From'} size={'small'}
                       fullWidth type="date" style={{marginBottom: 10}} InputLabelProps={{shrink: true}}/>
                <Field component={TextField} name="title" variant={'outlined'} label={'To'} size={'small'}
                       fullWidth type="date" style={{marginBottom: 10}} InputLabelProps={{shrink: true}}/>
                <Field component={TextField} name="title" variant={'outlined'} label={'Event title'} size={'small'}
                       fullWidth/>
